...
const Topbar = ({ dark, children }) => <header className={`${dark ? 'border-b border-gray-100' : ''} row-start-1 row-end-2 col-start-1 col-end-9 z-10 flex items-center justify-between px-4 md:px-6 py-4`}>{children}</header>
